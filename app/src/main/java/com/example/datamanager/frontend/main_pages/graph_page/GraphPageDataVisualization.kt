 ...
 * @param modelName The name of the model being displayed (default is "Approximation").
 * @param modelColumnName The column name in the model data frame to display (default is "Approximation").
 */
@Composable
fun DataView(
